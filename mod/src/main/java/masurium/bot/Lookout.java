...
final class Lookout {
    ...
    private boolean moveAwayFrom(Minecraft mc, LocalPlayer p, Entity of) {
        ...
        Route.Result r = Route.search(world, here,
                ...
                new Route.Options(MasuriumBot.safeFall(p.getHealth()), 4_000,
     ...
     */
    /**
     * The nearest phantom in sight (within SKY), or null. MasuriumBot's sleep-alone
     * routine checks it.
     */
    ...
    private void phantoms(Minecraft mc, LocalPlayer p) {
        ...
        // (MasuriumBot.sleepAlone) and only notifies if it has no bed or cannot manage.
