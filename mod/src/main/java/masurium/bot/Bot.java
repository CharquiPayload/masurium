...
public final class Bot {
    ...
    public static final String NAME_PROPERTY = "masurium.name";

    /** Where to go on start, so a bot never waits at the menu for a click. */
    public static final String SERVER_PROPERTY = "masurium.server";

    /** Which port this bot's hands listen on. Read by the mod itself, checked here. */
    public static final String PORT_PROPERTY = "masurium.bot.port";
     ...
     */
    public static final String HEADLESS_PROPERTY = "masurium.headless";
